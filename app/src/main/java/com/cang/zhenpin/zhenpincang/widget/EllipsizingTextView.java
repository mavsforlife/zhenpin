...
public class EllipsizingTextView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.EllipsizingTextView);
        maxExpandLines = array.getInteger(R.styleable.EllipsizingTextView_maxExpandLines, 3);
        duration = array.getInteger(R.styleable.EllipsizingTextView_duration, 500);
        array.recycle();
    }
    ...
    protected void onFinishInflate() {
        ...
        id_source_textview = findViewById(R.id.id_source_text_view);
        id_expand_textview = findViewById(R.id.id_expand_text_view);
...
//                startAnimation(animation);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        id_source_textview.setMinLines(1);
        super.onMeasure(widthMeasureSpec, heightMeasureSpec);
    ...
    private class ExpandCollapseAnimation extends Animation {
        ...
        protected void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            EllipsizingTextView.this.getLayoutParams().height = height;
